...
public:
	...
	static std::vector<vk::DescriptorSet> AllocateDescriptorSets(vk::Device& device, vk::DescriptorPool& descriptorPool,
	...
	static void UpdateDescriptorSets(vk::Device& device, const std::vector<vk::WriteDescriptorSet>& descriptorWrites,
	...
	static vk::WriteDescriptorSet CreateDescriptorWrite(vk::DescriptorSet& descriptorSet, uint32_t binding, vk::DescriptorType descriptorType, uint32_t descriptorCount,
	                                                    vk::ShaderStageFlags stageFlags, const vk::DescriptorBufferInfo* bufferInfo = nullptr,
